...
# TODO: combine this file w. generate_few_shot_data.py
root = '../data/Pipework/Pipework-yc'
target = '../data/PipeworkFewshot'

train_data_path = os.path.join(root, 'pipework_train_8192pts_fps.dat')
test_data_path = os.path.join(root, 'pipework_test_8192pts_fps.dat')
# train
